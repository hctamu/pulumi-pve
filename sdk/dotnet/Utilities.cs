...
namespace Hctamu.Pve
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/hctamu/pulumi-pve";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Hctamu.Pve.version.txt");
    ...
    internal sealed class PveResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public PveResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
