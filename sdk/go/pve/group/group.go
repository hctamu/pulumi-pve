...
func NewGroup(ctx *pulumi.Context,
	...
	if args.Comment == nil {
		args.Comment = pulumi.StringPtr("Default group comment")
	}
	...
	var resource Group
	err := ctx.RegisterResource("pve:group:Group", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGroup(ctx *pulumi.Context,
	...
	var resource Group
	err := ctx.ReadResource("pve:group:Group", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
