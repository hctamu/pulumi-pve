...
func TestParseCPUFromVMConfig(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			inputs, err := convertVMConfigToInputs(testVM, nil)
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			for i, expectedInterface := range tc.expectedOrder {
				...
				expectedKey, expectedValue := ToProxmoxDiskKeyConfig(*inputDisk)
...
func TestBuildOptionsConsistentOrdering(t *testing.T) {
	...
	for i, disk := range disks {
		expectedInterfaces[i], _ = ToProxmoxDiskKeyConfig(*disk)
	}
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			if tc.shouldPreserveOrder {
				...
				for i, expectedInterface := range tc.expectedDiskOrder {
					...
					expectedKey, expectedConfig := ToProxmoxDiskKeyConfig(*inputDisk)
...
func TestVMReadDiskOrderPreservation(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			result, err := convertVMConfigToInputs(mockVM, currentInput.Disks)
			require.NoError(t, err)
...
func TestBuildOptionsDiskConfiguration(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			actualKey, actualValue := ToProxmoxDiskKeyConfig(*tc.disk)
