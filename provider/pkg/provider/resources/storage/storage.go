...
var (
	_ = (infer.CustomResource[Inputs, Outputs])((*File)(nil))
	_ = (infer.CustomDelete[Outputs])((*File)(nil))
	_ = (infer.CustomRead[Inputs, Outputs])((*File)(nil))
	_ = (infer.CustomUpdate[Inputs, Outputs])((*File)(nil))
)
